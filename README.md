...
PrismaFlow is a software made by programmers for programmers. This app give you tools for developing apps like a todo-list, chat between friends, calendary and more tools. Currently we have four options:
  ...
  - **Beta tester:** This is an exclusive role because only selected people can be beta tester, for trying the newtest functions and giving us a review every time.
  - **Member:** You have everything unlocked for **free** if you are member of our team, we are'nt currently hiring, but if you wanna promote us try contacting us via e-mail.

## Backend
This is the section for the Backend, so you can take a look to how we process your data and the techologies that we use. Obviously the important information is saved with a dotenv, don't waste your time searching it.

  - **Technologies used in this proyect:**
    - NextJS _(TypeScript)_
    - React _(TypeScript + HTML)_
    - TailwindCSS _(CSS)_

## Members
  - **Proyect Manager** José Rafael Martínez Bocanegra:, programmer, designer and developer.