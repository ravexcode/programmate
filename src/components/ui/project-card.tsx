...
export default function ProjectCard(props : Props) {
  return (
    ...
    className="group relative w-full flex flex-col rounded-sm border border-neutral-800 bg-neutral-950 cursor-pointer duration-400 hover:-translate-y-1 hover:border-main p-5 h-full">
      ...
      className="flex items-start justify-between mb-3">
        ...
        className="w-full flex flex-col gap-1">
          ...
          <p
          className="text-sm text-neutral-400 font-medium tracking-wide flex justify-start items-center gap-2">
            <span
      ...
      <p
      className="text-sm text-text/60 line-clamp-3 leading-relaxed max-h-18">
        {
