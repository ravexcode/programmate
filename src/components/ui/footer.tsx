function CustomLi(props: any){
  return (
    <li>
      <a href={props.link}
       className="cursor-pointer duration-200 hover:text-ultramarine-blue-500">
        {props.children}
      </a>
    </li>
  )
...
export default function Footer(){
  return (
    <footer
    className="bg-black flex flex-col justify-center items-center px-4 pt-3 pb-15 z-10 text-text mt-auto">
      <img src="/logos/large_white.svg" alt="Logo made by RavexCode"
      className="h-7 mb-5"/>
      
      <div
      className="flex gap-10 md:gap-30 flex-wrap justify-start md:justify-center items-start">
