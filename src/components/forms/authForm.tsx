export default function AuthForm(props: any){
  return (
    <form
    className="flex flex-col justify-start items-center px-6 py-3 text-text max-w-[95dvw] w-120 z-2 animate-fade-in"
    onSubmit={props.onSubmit}
    ref={props.ref}>
      <img src="/logos/white.svg" alt="Prismaflow Icon made by RavexCode"
