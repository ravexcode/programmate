...
* Submit pull requests or contribute improvements to the official repository.
* Use portions of the code for learning and experimentation.

## 3. Restrictions

Without prior written permission from Ravexcode, you may **not**:
...
[contact@ravexcode.com](mailto:contact@ravexcode.com)
...
The Software is licensed, not sold. All intellectual property rights remain the exclusive property of Ravexcode.
